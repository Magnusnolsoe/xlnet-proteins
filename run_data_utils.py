...
input_file = 'mini_train.txt' # name of the input file (including file extension) 
data_dir = 'data' # path of input data directory
save_dir = 'proc_data' # path of the save data directory
