...
def main(unused_args):
    ...
    experiment = conn.experiments().create(
        ...
        metrics=[dict(name='loss', objective='minimize'), dict(name='acc', objective='maximize')],
        parameters=[
                ...
                dict(name='batch_size', type='categorical', categorical_values=['8', '16', '32', '64', '128']),
                dict(name='learning_rate', type='double', bounds=dict(min=1e-10, max=1e-6)), # Multiply
                dict(name='lr_layer_decay_rate', type='int', bounds=dict(min=0, max=10)),
